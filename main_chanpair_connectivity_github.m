...
for age = 1:2
    ...
    for s = 1:length(sub_list)
        ...
        %% Load data (each condition have a different name, so create data as a common variable
        ...
        switch type
            case 2
                ...
                save (save_data, 'ispc_FC', 'ispc_PC', 'ispc_OC', '-v7.3');
            ...
            case 1
                ...
                save (save_data2, 'ispc_FC', 'ispc_PC', 'ispc_OC', '-v7.3');  
        end
    end
end